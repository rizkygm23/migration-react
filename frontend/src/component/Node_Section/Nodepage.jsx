...
const NodePage = () => {
  ...
  return (
    ...
    id="nodes" className="justify-between md:max-w-screen-md container px-10 grid grid-cols-1 pt-10 lg:max-w-screen-xl mx-auto mt-20 mb-56 bg-slate-100 bg-opacity-0 ">
      ...
      <div id="card-UIUX" className="container grid grid-cols-1 max-w-screen-sm md:max-w-screen-2xl mt-10 md:grid-cols-2 lg:grid-cols-3 gap-10">
      {uiuxCards.map(card => (
