...
const CardnodeMin = ({ imgsrc, alt, title, detail, role }) => {
    return (
        ...
        className={`relative card  p-6 bg-[#12122B] min-w-fit   md:p-3 lg:p-4 rounded-[13px] md:rounded-[17px] lg:rounded-[21px] delay-100 max-w-full duration-300 overflow-hidden  md:max-w-screen-sm transition-transform ease-in-out hover:-translate-y-1 hover:shadow-sm hover:shadow-sky-200`}>
        {/* Name and logo */}
        <div 
            id='nameLogo'
            ...
            <h3 className=" text-[16px] w-full  col-span-2 md:text-[16px] lg:text-[24px] font-semibold text-slate-400 text-wrap text-left my-auto">{title}</h3>
